...
class LLMEnsemble:
    ...
    def __init__(self, models_cfg: List[LLMModelConfig]):
        ...
        self.models = [self._create_client(model_cfg) for model_cfg in models_cfg]
    ...
    @staticmethod
    def _create_client(model_cfg: LLMModelConfig) -> LLMInterface:
        """Create the appropriate LLM client based on model config."""

...
class OpenEvolve:
    ...
    def _setup_logging(self) -> None:
        ...
        # Remember the resolved log file path so worker processes can route
        # their records to the same sink via a QueueHandler → QueueListener.
    ...
    async def run(
        ...
        if should_add_initial:
            ...
            # Store initial program artifacts so children can see them
